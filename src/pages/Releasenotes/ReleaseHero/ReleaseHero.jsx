...
const ReleaseHero = () =>{
    ...
    return (
        ...
        <section className="services__area pt-115 pb-10">
         ...
         <section className="services__area pt-0 pb-10">
            <div className="container">
               <div className="row">
                  <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
               ...
               <div className="row">
                  <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div className="section__title section__title-3 mt-100 mb-10 wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <ul>
                           <li className='pb-50'>New In-Build Security Authentication & Authorization for Prediction API</li>
                        </ul>
         ...
         <section className="services__area pt-25 pb-10">
            <div className="container">
               <div className="row">
                  <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div className="section__title section__title-3 mt-0 mb-10 wow fadeInUp" data-wow-delay=".2s">
                        <div className='pb-40'>
                            <h3>2022.5.0-elite</h3>
                        </div>
                        <h4 className='rel'>This release of the OneNine AI Cloud Platform includes new enhancements and bug fixes:</h4>
                        <h4 className='rel pt-30'>New Features & User Experience</h4>
                        <ul>
                        ...
                        <ul>
                           <li>Added new Dynamic Access that allows users to seamlessly connect to databases, datasets and charts</li>
                        </ul>
         ...
         <section className="services__area pt-5 pb-10">
            <div className="container">
               <div className="row">
                  <div className="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div className="section__title section__title-3 mt-0 mb-10 wow fadeInUp" data-wow-delay=".2s">
                        <div className='pb-40'>
                            <h3>2022.4.0-elite</h3>
                        </div>
                        <h4 className='rel'>This release of the OneNine AI Cloud Platform includes new enhancements and bug fixes:</h4>
